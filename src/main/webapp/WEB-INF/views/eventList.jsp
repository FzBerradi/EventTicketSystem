...
<!-- ======= Hero Section ======= -->
   <section id="hero" class="hero" style="height : 98vh ; border : 1px">
    <div class="container position-relative">
      <div class="row gy-5 p-3 my-3" style="border : 1px solid #efefef ; border-radius : 10px" data-aos="fade-in">
		    ...
		    <table class="table table-striped">
		        ...
		        %>
		        <tr>
				    <td data-label="Event Name"><%= event.getName() %></td>
				    <td data-label="Location"><%= event.getLocation() %></td>
				    <td data-label="Date"><%= event.getDate() %></td>
				    <td data-label="Price">$<%= event.getBasePrice() %></td>
				    <td data-label="Book"><a class="btn btn-success" href="booking?eventId=<%= event.getId() %>">Book Now </a></td>
				</tr>
	    ...
	    <% String role = (String) user.getRole();
			 if (role.equals("Admin")) { %>
			  <!-- Bouton avec lien -->
<a href="ajouterEvent" class="btn btn-success mb-3" style="color: white; text-decoration: none;">Add Event</a>

<!-- Bouton input -->
<!-- <input type="button" class="btn btn-success mb-3" value="Add Event" onclick="window.location.href='ajouterEvent';" style="color: white; cursor: pointer;"> -->
