		...
		<div class="container position-relative">
			<div class="row gy-5 p-3 my-3"
				...
				<div
					...
					<h2 class="p-0 my-2 text-center">Log in</h2>
					...
					<form action="LoginServlet" method="post">
						...
						<div class="mt-2 text-center">
							<input type="submit" class="btn-get-started" value="Log in" />
						</div>
					</form>
					<div class="d-flex justify-content-center my-2">
						<p>
							I don't have an account? <a href="register" style="color: white">Register</a>.
						</p>
					</div>
				</div>
				<div class="col-lg-6 order-1 order-lg-2">
					<img src="assets/img/login.webp" class="img-fluid w-100 " alt=""
